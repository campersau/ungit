...
describe('git-api branching', function () {
  ...
  it('should be possible to commit to master', async () => {
  ...
  it('listing branches should work', async () => {
  ...
  it('listing branches should show the new branch', async () => {
    const res = await common.get(req, '/branches', { path: testDir });
  ...
  it('listing branches should show the new branch as current', async () => {
    const res = await common.get(req, '/branches', { path: testDir });
    expect(res.length).to.be(2);
    expect(res[0].name).to.be('master');
  ...
  it('should be possible to commit to the branch', async () => {
  ...
  it('log should show both branches and all commits', async () => {
  ...
  it('status should list the changed file', async () => {
